...
export default function Home() {
  return (
    <>
      <Head>
        <title>Max Xu's Portfolio</title>
      ...
      <div className="background-white">
        ...
        <div id="projects"></div>
        <div className="flex flex-col md:flex-row mx-auto py-20 px-4 md:px-8 lg:px-10">
          <div className="md:w-1/3 flex flex-col justify-center items-start h-[50vh] md:ml-[10vh] mb-8 md:mb-0 mt-[13vh]">
            <h2 className="font-sans text-2xl md:text-5xl mb-4 text-black dark:text-white">
              My Projects.
            </h2>
            <p className="font-sans text-3xl md:text-2xl text-neutral-700 dark:text-neutral-300 text-base md:text-lg mb-8">
              More information about each of my projects can be found on my <a href="https://hxu64.github.io/categories/projects/">project site</a>.
            </p>


            <a href="https://hxu64.github.io/categories/projects/" target="_blank" rel="noopener noreferrer">
              <HoverBorderGradient
                containerClassName="rounded-full"
                as="button"
                className="dark:bg-black bg-white text-black dark:text-white flex items-center space-x-2"
              >
                ...
                <span className="font-sans">Projects Site</span>
              </HoverBorderGradient>
            </a>
          </div>
          <div className="md:w-2/3 md:ml-[5vh]">
            <ProjectsCarousel />
          </div>
        </div>
